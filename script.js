...
function showSection(sectionId) {
  const sections = ["solarSection", "statsSection"];
  sections.forEach(id => {
...
function calculateSavings() {
  ...
  // Costo sin paneles es el monto del recibo bimestral
  const costWithoutSolar = billAmount;
  // Energía generada bimestral = energía mensual * 2
  const generatedBimonthly = monthlyEnergy * 2;
  // Costo con paneles: se resta la energía generada del consumo (mínimo 0)
